package com.software.ustc.superspy.activity;/*Copyright ©2015 TommyLemon(https://github.com/TommyLemon)
...
public class WebViewActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_view);//传this是为了全局滑动返回

        //////////////////////////
        progressBar= (ProgressBar)findViewById(R.id.pbWebView);//进度条
...
//        webView.loadUrl("http://139.196.35.30:8080/OkHttpTest/apppackage/test.html");//加载url
        webView.loadUrl("https://github.com/jiawei96-liu/SuperSpy/commits/main");
